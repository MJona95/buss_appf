...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<TripModel> _allTrips = [
    ...
    TripModel(
      ...
      rating: 4.5,
      isBookmarked: false,
      imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA3iK_AaReJ1sZ9g_9-k_4K66Pm_eBROrVtQxTXgMBIwBFCjRiotQ6dyZJPUqnbFUjicy1HBfApN82ZHTgN1iKPMrhAiKSKkFCO4SSJbo7ILZpYUWai9Kqy6Ylkehn1dmltIdqOGozEogLv1p9gVjf_bcaKVzI8lLK2Mkpxt2IozoPwd2Mb-XZAs4N77q9xrv_El1rtK6ayfOx-JSM5zX1SW1eDqTq2wHdVuwag0zKdRYsh5xFr3UI0mmTbqDKWFYI5H_dTl8tRdRkA',
      isAvailable: false,
    ),
  ];
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: IconButton(
                          icon: const Icon(Icons.search, color: AppTheme.onBackgroundColor),
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: isActive ? Colors.white : AppTheme.onBackgroundColor,
                                ),
                              ),
                            ],
                          ),
                    ...
                    onViewDetails: () {
                      if (_trips[index].isAvailable) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Details for ${_trips[index].companyName}'),
